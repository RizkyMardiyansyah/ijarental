<header id="header">
    <button id="whatsapp">
        <a href="https://wa.me/6281268258986" target="_blank">
            <span class="contact-text" data-lang-en="Contact Us" data-lang-id="Hubungi Kami">Hubungi Kami</span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="logo-nav">
                    <a href="/">
                        <img style="height: 30px" src="images/Ij_rental_logo_putih.svg" alt="Rental Mobil Kota Padang" title="Rental Mobil Kota Padang" />
                    </a>
                </div>
                <!--End Logo -->
                ...
                <div id="main-menu" class="collapse scroll navbar-right">
                    <ul class="nav">
                        ...
                        <li class="active"> <a class="nav-link" href="/#ija-rental-mobil-padang" data-lang-en="Home" data-lang-id="Beranda">Beranda</a> </li>
                        <li class="has-submenu">
                            <a class="nav-link" href="/#layanan-ija-rental-mobil-padang" data-lang-en="Services" data-lang-id="Layanan">Layanan</a>
                            <ul class="submenu container">
                                <li><a class="menu-link" href="/#armada-ija-rental-mobil-padang" data-lang-en="Fleet" data-lang-id="Armada">Armada</a></li>
                                <li><a class="menu-link" href="/#tur-ija-rental-mobil-padang" data-lang-en="Tour" data-lang-id="Tur">Tur</a></li>
                            </ul>
                        </li>  
                        ...
                        <li> <a class="nav-link" href="/faq" data-lang-en="FAQ" data-lang-id="Pertanyaan">Pertanyaan</a> </li>                     
                        ...
                        <div class="language-selector order-lg-2">
                            <div class="toggle-container">
                                ...
                                <label class="toggle-label" for="languageToggle">
                                    <span class="toggle-inner">IN</span>
