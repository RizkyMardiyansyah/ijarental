...
<html lang="en-gb" class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Rental Mobil Terpercaya di Kota Padang | Armada Ija Rental</title>
    ...
    <!--End Navigation-->
		...
		<section id="single-work" class="section">
			<div class="container">
				<div class="row">					
					<div class="col-md-7">
							<div class="item"><img src="{{ asset('storage/' . $car->image) }}" alt="Rental Mobil {{ $car->nama }} Padang"></div>						 
					</div>
					...
					<div class="col-md-5 work-detail">
						...
						<ul class="work-detail-list">
							<li><span>Kapasitas </span>{{ $car->kapasitas }}</li>
							<li><span>Durasi Rental</span>{{ $car->durasi_rental }}</li>
							<li><span>Harga Termasuk</span>{{ $car->harga_termasuk }}</li>
                            <li><span>Harga</span>@if($car->tambah_harga)
