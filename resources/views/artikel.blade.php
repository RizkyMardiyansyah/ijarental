...
<html lang="en-gb" class="no-js">
	<head>
		<meta charset="utf-8">
	  	<title>Rental Mobil Terpercaya di Kota Padang | {{ $blog->judul }}</title>
						...
						<div class="post-content">	
							...
							<div class="post-meta">
                                <ul class="list-inline">
                                  <li><a href="#"><i class="fa fa-calendar"></i>{{ $blog->published_at }}</a> </li>
                                  <li><a href="#"><i class="fa fa-user"></i>by {{ $blog->penulis }}</a></li>
                                </ul>
							</div>
							<!-- /Post Meta-->
